...
class UI {
  ...
  imprimirCitas() {
    ...
    //Leer el contenido de la bd - Read
    const objectStore = DB.transaction("citas").objectStore("citas");

    const fnTextoHeading = this.textoHeading;
    //Contador de registros del indexdb
    ...
    //Con cursor iteramos sobre cada registro, similar al forEach
    objectStore.openCursor().onsuccess = function (e) {
      ...
      if (cursor) {
        ...
        //Ve al siguiente elemento y haz lo mismo
        cursor.continue();
      }
    };
  }
...
function crearDB() {
  ...
  crearDB.onsuccess = function () {
    ...
    //Mostrar citas al cargar (pero con IndexDB ya está listo)
    ui.imprimirCitas();
  };
